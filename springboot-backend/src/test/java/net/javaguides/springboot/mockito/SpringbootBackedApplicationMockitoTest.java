...
public class SpringbootBackedApplicationMockitoTest {
	...
	@Test
	 public void getEmployeeByIdTest()throws ResourceNotFoundException {
		...
		Optional<Employee> employee=Optional.of(new Employee("Dinesh","Derangula","dineshderangula@gmail.com"));
		...
		assertEquals("derangula",emp.getLastName());
		assertEquals("dineshderangula@gmail.com",emp.getEmailId());
		}
	...
	public void deleteEmployeeByIdNotFound() {
		Employee employee=new Employee("dinesh","derangula","dineshderangula@gmail.com");
		 employee.setId(1L);
	...
	public void updateEmployeeById() {
		Employee employee=new Employee("hoo","hii","t@gmail.com");
		employee.setId(12L);	
